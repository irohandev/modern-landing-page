  ...
  return (
    ...
    >
      <div className="max-w-[570px] flex flex-col items-center relative">
        ...
        />
        <div className="text-4xl md:text-5xl lg:text-5xl py-6 font-bold tracking-tighter text-center bg-gradient-to-b from-black to-[#002499] text-transparent bg-clip-text">
